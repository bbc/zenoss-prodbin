...
newDescriptions = {
    "apply-custom-patches": "Apply custom patches to the service.",
    ...
    "install-percona": "Install Percona.",
    ...
    "reportmail": "Generate and email a status report.",
    "upgrade": "Start a service migration.",
    "zendmd": "Start an interactive Zenoss DMD session.",
